...
* Browse/Explore database files (ctrl-shift-e)
...
* Firefox 3.5, IE8 or Opera 10.5
  (Chrome not recommended as it doesn't format raw XML output)
...
!http://github.com/robwhitby/DQ/blob/master/screenshot.jpg?raw=true!
